...
A sensitivity analysis in the evaluation illustrates this directly: for a typical pair, changing the air-filled ring-down time by only \SI{0.5}{\micro\second} changes $\beta$ by about $3.1\times 10^{-5}\,\si{m^{-1}}$, i.e.\ by an amount comparable to the expected Rayleigh signal itself.
