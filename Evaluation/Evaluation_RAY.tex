...
\[
\overline{T}=\SI{20.08}{\celsius}=\SI{293.23}{K},\qquad \overline{p}=\SI{1018.10}{mbar}=\SI{1.01810e5}{Pa}.
\]
...
\[
N=(2.5148\pm 0.0050)\times 10^{25}\,\si{m^{-3}}.
\]
...
\begin{equation}
\boxed{\beta_\mathrm{th}=(3.909\pm 0.008)\times 10^{-5}\,\si{m^{-1}}} \, .
\label{eq:beta_th}
\end{equation}
